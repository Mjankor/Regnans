 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 16.9f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.296f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.101f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.159f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 20000, 20000, 300, 10000 }
...
// :[1,2,3,4,5,6,7,8]
#define NUM_M106_FANS 5 //MJA note - prevents extruder fan (PWM6) from being controlled.
