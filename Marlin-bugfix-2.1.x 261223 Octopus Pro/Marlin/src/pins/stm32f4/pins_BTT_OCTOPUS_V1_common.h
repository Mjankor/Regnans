...
// Heaters / Fans
//
#define HEATER_BED_PIN                      PB11 //PA1   // Hotbed Note: Swapped with Heater 3 to allow bed mosfet to be activated without second 24V supply
#define HEATER_0_PIN                        PA2   // Heater0
#define HEATER_1_PIN                        PA3   // Heater1
#define HEATER_2_PIN                        PB10  // Heater2
#define HEATER_3_PIN                        PA1 // PB11  // Heater3
