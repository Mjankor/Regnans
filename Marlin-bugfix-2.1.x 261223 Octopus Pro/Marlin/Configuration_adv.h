...
#define ENDSTOPS_ALWAYS_ON_DEFAULT //set here endstops on all time MJA
...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #define Z_STEPPER_ALIGN_XY { { 40, 175 }, { 310,  175 } }
  ...
  //#define Z_STEPPER_ALIGN_STEPPER_XY { { 210.7, 102.5 }, { 152.6, 220.0 }, { 94.5, 102.5 } }
    ...
    #define Z_STEPPER_ALIGN_AMP 1.25       // Use a value > 1.0 NOTE: This may cause instability!
  #endif
...
//#define FT_MOTION
  ...
  #define FTM_SHAPING_DEFAULT_X_FREQ 55.0f              // (Hz) Default peak frequency used by input shapers.
  #define FTM_SHAPING_DEFAULT_Y_FREQ 55.0f              // (Hz) Default peak frequency used by input shapers.
  #define FTM_LINEAR_ADV_DEFAULT_ENA false              // Default linear advance enable (true) or disable (false).
  #define FTM_LINEAR_ADV_DEFAULT_K    0.0f              // Default linear advance gain.
  #define FTM_SHAPING_ZETA_X            0.15f      // Zeta used by input shapers for X axis
  #define FTM_SHAPING_ZETA_Y            0.15f      // Zeta used by input shapers for Y axis
  ...
  #define FTM_POINTS_PER_LOOP         100         // Number of trajectory points to generate each loop()
    ...
    #define FTM_STEPPER_FS          120000 //mja quadrupled both values. 
    #define FTM_STEPPERCMD_BUFF_SIZE 24000
  #endif
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  55          // (Hz) The default dominant resonant frequency on the X axis. //MJA Settings for Regnams
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  55          // (Hz) The default dominant resonant frequency on the Y axis. //MJA Settings for Regnams
    #define SHAPING_ZETA_Y  0.15f       // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #define SHAPING_MIN_FREQ  45        // By default the minimum of the shaping frequencies. Override to affect SRAM usage.
  #define SHAPING_MAX_STEPRATE 30000  // By default the maximum total step rate of the shaped axes. Override to affect SRAM usage.
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 125*60, 125*60, 25*60, 15*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SD_FINISHED_RELEASECOMMAND "M84XYE"  // Use "M84XYE" to keep Z enabled so your bed stays in place. Woah, this is bad on a CoreXY. Remove. MJA
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH       66  // (mm) The length of filament for a complete unload.
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_5_DESC "Textured Sheet"
  #define MAIN_MENU_ITEM_5_GCODE "M851 Z-1.2 \n M117 Textured Set@-1.2"
  //#define MAIN_MENU_ITEM_5_CONFIRM

  #define MAIN_MENU_ITEM_6_DESC "PrintBite Sheet"
  #define MAIN_MENU_ITEM_6_GCODE "M851 Z-0.75 \n M117 Printbite Set@-0.75"
  //#define MAIN_MENU_ITEM_6_CONFIRM

  #define MAIN_MENU_ITEM_7_DESC "Cooldown"
  #define MAIN_MENU_ITEM_7_GCODE "M140 S0 \n M104 S0 \n M117 Cooling Hotend and Bed."
  //#define MAIN_MENU_ITEM_7_CONFIRM

    #define MAIN_MENU_ITEM_8_DESC "Swap Nozzle"
  #define MAIN_MENU_ITEM_8_GCODE "G28\nG1 X125 Y50 Z200 F2000\nM104 S275\nM117 Setting Nozzle to 275C\nG4 s10\nM0 Click when Finished\nM104 S0"
  //#define MAIN_MENU_ITEM_8_CONFIRM

  #define MAIN_MENU_ITEM_9_DESC "Change Filament"
  #define MAIN_MENU_ITEM_9_GCODE "M600"
  //#define MAIN_MENU_ITEM_9_CONFIRM

  #define MAIN_MENU_ITEM_10_DESC "Disable X/Y/E Steppers"
  #define MAIN_MENU_ITEM_10_GCODE "M18 X Y E \n M117 X,Y and E steppers disabled."
  //#define MAIN_MENU_ITEM_10_CONFIRM

  #define MAIN_MENU_ITEM_11_DESC "Switch to Spreadcycle on X/Y"
  #define MAIN_MENU_ITEM_11_GCODE "M569 S0 X Y"
  //#define MAIN_MENU_ITEM_11_CONFIRM

  #define MAIN_MENU_ITEM_12_DESC "Switch to Stealthchop on X/Y"
  #define MAIN_MENU_ITEM_12_GCODE "M569 S1 X Y"
