 ...
 */
//#define ADAPTIVE_STEP_SMOOTHING //test this MJA No change
 ...
 */
  ...
  /**
   * T//MC Homing stepper phase. No change. 
   *
   ...
   */
  //#define SQUARE_WAVE_STEPPING //first test to quieten steppers. MJA No change. 
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_6_DESC "Change Filament"
  #define MAIN_MENU_ITEM_6_GCODE "M600"
