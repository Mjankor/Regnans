...
#define STRING_CONFIG_H_AUTHOR "(MJA Regnans CoreXY)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CoreXY Regnans"
...
#define MPCTEMP        // ** EXPERIMENTAL ** //Add this in future -= MJA
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 23.9f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.267f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.132f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.188f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
//#define USE_YMIN_PLUG //change for regnans 2 - MJA
...
// Enable pullup for all endstops to prevent a floating state. //MJA sensorless homing needs X & Y pulled up. Z needs to be pulled up as activating the sensor goes to ground.
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // Set to true to invert the logic of the probe.//MJA False for PINDA, True for Tron
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 400, 562 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.1 // (mm) Distance from real junction edge //edit mja jan 22
...
/**
 * Z_MIN_PROBE_PIN //check here it if can't find the probe MJA
 *
 ...
 */
#define Z_MIN_PROBE_PIN P0_10 // Pin 10 used to avoid the SKR 1.4 Zswitch bug with probes MJA.
...
#define INVERT_Y_DIR false //axis fix here MJA
...
// :[-1,1]
#define X_HOME_DIR -1 //update for Regnans 2 - MJA
#define Y_HOME_DIR 1
#define Z_HOME_DIR -1
//#define I_HOME_DIR -1
//#define J_HOME_DIR -1
...
#define Y_MAX_POS Y_BED_SIZE// //edit here for shifted nozzle/endstop positions. MJA
...
#define FIL_RUNOUT_PIN P1_26 //added for SKR board MJA
...
#define PREHEAT_4_TEMP_HOTEND 10
#define PREHEAT_4_TEMP_BED    10
#define PREHEAT_4_TEMP_CHAMBER 35
#define PREHEAT_4_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_5_LABEL       "NozzleSwap"
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MIN_POS + 10), 10 } //Testing for Marlin Bug Dec 2023 MJA
  //#define NOZZLE_PARK_POINT { 2, 2, 10 }
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER //change here MJA
